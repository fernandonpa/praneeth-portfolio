  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "Praneeth Anjana",
          from_email: form.email,
          to_email: "praneeth.22@cse.mrt.ac.lk",
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          <label className="flex flex-col">
            ...
            <textarea
              ...
              value={form.message}
              onChange={handleChange}
              placeholder="Hey Praneeth, love the website! I'd like to chat about some opportunities you might like! 🎉"
              className="bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outline-none border-none font-medium transition-all duration-300 focus:ring-2 focus:ring-purple-500"
            />
          </label>
        ...
        >
          Copyright &copy; {new Date().getFullYear()} Praneeth Anjana' s
          Portfolio
          <br />
          Designed and Developed by
          <a
            href="https://www.linkedin.com/in/praneeth-anjana-720987274"
            target="_blank"
            rel="noopener noreferrer"
            className="font-bold text-purple-500 hover:text-purple-400 transition-colors duration-300 ml-1"
          >
            Praneeth Anjana Fernando
          </a>
        </motion.p>
      </motion.div>
