        ...
        >
          ...
          <div className="mt-10 flex flex-wrap gap-5 justify-center">
            ...
            <motion.button
              ...
              onClick={() =>
                window.open(
                  "https://www.linkedin.com/in/praneeth-anjana-720987274/",
                  "_blank"
                )
              }
            >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={() =>
                window.open("https://github.com/fernandonpa", "_blank")
              }
            >
        ...
        >
          ...
          >
            ...
            >
              ...
              <span>
                BSc Computer Science Engineering undergraduate at University of
                Moratuwa, passionate about transforming data into intelligent
                solutions.
              </span>
            </motion.li>
            ...
            >
              <span className="mr-4 text-2xl flex-shrink-0">🤖</span>
              <span>
                AI/ML Enthusiast specializing in Data Science, Machine Learning,
                NLP, and building intelligent agents for complex workflows.
              </span>
            </motion.li>
            ...
            >
              <span className="mr-4 text-2xl flex-shrink-0">🛠</span>
              <span>
                Data Scientist & Analyst with MLOps expertise, turning raw data
                into meaningful insights that drive business innovation.
              </span>
            </motion.li>
            ...
            >
              <span className="mr-4 text-2xl flex-shrink-0">👨‍💻</span>
              <span>
                Full-Stack Developer skilled in integrating AI solutions into
                robust software systems, bridging research and practical
                implementation.
              </span>
            </motion.li>
            ...
            >
              <span className="mr-4 text-2xl flex-shrink-0">🚀</span>
              <span>
                Always curious and learning, I solve real-life challenges by
                integrating AI into systems for innovative solutions.
              </span>
            </motion.li>
          </motion.ul>
        </motion.div>
